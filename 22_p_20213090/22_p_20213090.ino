...
// Framework setting
#define _DIST_TARGET 240    // [20213085] 정지하려는 위치 목표값
#define _DIST_MIN 100       //[20191979] 최소거리
#define _DIST_MAX 410       //[20191979] 최대거리

// Distance sensor
#define _DIST_ALPHA 0.4 //[20203118] DIST_ALPHA 값 설정

// Servo range
#define _DUTY_MIN 1000    // [20213083]서보 각도의 최솟값 설정
#define _DUTY_NEU 1400    // [20213090]서보 수평 각도 펄스 값
#define _DUTY_MAX 1700    // [20213081] 서보 각도의 최댓값
...
float dist_raw, dist_ema, alpha; //[20203118] 거리와 노이즈 필터 적용 후 거리를 저장하기 위한 변수
...
// move servo to neutral position
  ...
  duty_curr = _DUTY_NEU; //[20203118] duty_curr 값 초기화
  ...
  duty_chg_per_interval = (_DUTY_MAX - _DUTY_MIN) * (_SERVO_SPEED / _SERVO_ANGLE) * ((float)_INTERVAL_SERVO / 1000.0);
}
...
//  dist_ema = alpha * val + (1 - alpha) * dist_ema;
  return val;
}
