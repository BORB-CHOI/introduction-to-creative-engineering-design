...
#define _SERVO_RATIO 10.277777777777778


#define _DIST_ALPHA 0.1 // EMA weight of new sample (range: 0 to 1) Setting this value to 1 effctively disables EMA filter.

// global variables
float timeout; // unit: us
float dist_min, dist_max, dist_raw, dist_prev, dist_ema, alpha, servo_ratio; // unit: mm
...
// 1 : 180 = x : 1850
// 180x = 1850
// x = 10.277777777777778

if (dist_ema >= 180 and dist_ema <= 360){
    analogWrite(PIN_LED, 0);
    myservo.writeMicroseconds(((dist_ema - 180) * servo_ratio) + 550);
} else {
